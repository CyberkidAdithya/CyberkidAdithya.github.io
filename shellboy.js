document.addEventListener('DOMContentLoaded', function() {
  ...
  var postHelpList = function(){
    ...
    var helpKeyWords = [
      ...
      "- YouTube + keyword to search directly in YouTube (ex. youtube blackhat inside)",
  ...
  var textReplies = function() {
    switch(textInputValueLowerCase){
      ...
      case "founder":
        clearInput();
        addTextToResults("Members of Shadow Breakerz Team are the founders");
        break;
      ...
      case "love":
        clearInput();
        addTextToResults("Awww! Love you too ❤");
        break;
 
      case "blackhat inside":
      case "PWN":
      case "programming":
        clearInput();
        addTextToResults('Web development examples!');
        openLinkInNewWindow('https://www.youtube.com/channel/UCEaVKfEPh7qf0-fp4oEiHxg');
        break;
      ...
      case "hola":
        clearInput();
        addTextToResults("Hello, I am your Personal Assistant here. Cyberkid made me using pure Js.");
        break;
